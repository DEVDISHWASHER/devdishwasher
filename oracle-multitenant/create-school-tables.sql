BEGIN
  EXECUTE IMMEDIATE ('DROP USER schooladmin CASCADE');
EXCEPTION
  WHEN OTHERS THEN
...
ALTER USER schooladmin ACCOUNT UNLOCK;
ALTER USER schooladmin QUOTA UNLIMITED ON users;

GRANT CONNECT, RESOURCE TO schooladmin;
GRANT CREATE VIEW to schooladmin;

CONN schooladmin/school@//localhost/XEPDB1
